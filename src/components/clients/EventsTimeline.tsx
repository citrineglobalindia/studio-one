...
const REQ_LABEL: Record<string, { short: string; full: string; color: string }> = {
  ...
  semi_candid_photographer: { short: "Semi-Candid Photo", full: "Semi-Candid Photographer", color: "bg-teal-500/10 text-teal-600 border-teal-500/30" },
  semi_candid_videographer: { short: "Semi-Candid Video", full: "Semi-Candid Videographer", color: "bg-sky-500/10 text-sky-600 border-sky-500/30" },
