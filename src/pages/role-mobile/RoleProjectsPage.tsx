  ...
  return (
    <div className="px-5 pt-5 pb-6">
      <div className="mb-4">
        ...
        <p className="text-[12px] text-muted-foreground">Assigned to {teamMember.full_name} · {events.length} total</p>
      </div>
      ...
      <div className="space-y-2.5">
        ...
        {filtered.length === 0 && (
          <div className="text-center py-12 text-muted-foreground text-sm">No events to show.</div>
        )}
      </div>
    </div>
  );
